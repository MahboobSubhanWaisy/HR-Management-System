...
<div class="col-md-12 bg-white p-4">
    <h3 class="bg-primary p-2 text-white text-center">Department Page</h3>
    <br>
    <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#modal"><span class="icon-plus">&nbsp;</span>New Department</button>
    <br><br>
        ...
        <table id="order-listing" class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $row->dep_title }}</td>
                    <td class="text-center">{{ $row->dep_description }}</td>
                    <td class="text-center">
                        <a href="#" class="edit" id="{{ $row->dep_id }}"><span class="icon-note text-primary" style="font-size: 17px;"></span></a>
                    </td>
                    <td class="text-center">
                        <a href="#" class="delete" data-id="{{ $row->dep_id }}"><span class="icon-close text-danger" style="font-size: 18px;"></span></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit').click(function() {
                id = $(this).attr('id');
                var url = "http://127.0.0.1:8000/editdep" + "/" + id;
                $.get(url, function(data) {
                    // console.log(data);
                    $('#title').val(data['dep_title']);
                    $('#discription').val(data['dep_description']);
                    $('#id').val(data['dep_id']);
                });
